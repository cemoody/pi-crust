...
await fs.writeFile(presentationSessionFile, JSON.stringify({
  ...
  messages: [
    { role: 'user', content: 'Create a QXO executive slide deck', timestamp: 1700000004000 },
    {
      role: 'custom',
      ...
      details: {
        ...
        artifacts: [{
          ...
          spec: {
            ...
            theme: 'brainco',
            slides: [
              { template: 'title', title: 'QXO Signal Brief', subtitle: 'Demand, weather, and pricing signals' },
